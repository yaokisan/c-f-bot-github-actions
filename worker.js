...
②C≧70% かつ 70%≧F>50% の場合
ピントは明瞭ですが、やや疲労が溜まっています。15分前後の仮眠/散歩/ストレッチなどリフレッシュを入れましょう。

③70%>C≧50% かつ F≦50% の場合
身体は元気ですが、ややピントがボケています。簡易アファメーションを入れましょう。

④70%>C≧50% かつ 70%≧F>50% の場合
ピントがややボケていて、疲労も溜まっています。15分前後の仮眠/散歩/ストレッチなどリフレッシュを入れ、その後簡易アファメーションを入れましょう。

⑤C<50% かつ 70%≧F>50% の場合
ピントがかなりボケており、目的や目標から丁寧に見直しが必要です。また、やや疲労が溜まっています。
